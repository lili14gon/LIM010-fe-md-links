...
const obj = [{
  href: 'https://translate.google.com/?hl=es#view=home&op=translate&sl=en&tl=es&text=serializes%20to%20the%20same%20string',
  text: 'link1',
  file: 'E:\\PROYECTOS DE LABORATORIA\\proyecto_4\\LIM010-fe-md-links\\prueba\\folder1\\archivo4.md',
  status: 200,
  statusText: 'OK'
}, {
  href: 'https://translate.google.com/?hl=es#view=home&op=translate&sl=en&tl=es&text=serializes%20to%20the%20same%20string',
  ...
  text: 'Firebase',
  file: 'E:\\PROYECTOS DE LABORATORIA\\proyecto_4\\LIM010-fe-md-links\\prueba\\folder1\\folder2\\archivo6.md',
  status: 200,
  statusText: 'OK'
}, {
